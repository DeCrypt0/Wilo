/* src/config/wilo-config.h.  Generated from wilo-config.h.in by configure.  */
/* src/config/wilo-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef WILO_CONFIG_H

#define WILO_CONFIG_H

/* Define if building universal (internal helper macro) */
/* #undef AC_APPLE_UNIVERSAL_BUILD */

/* Version Build */
#define CLIENT_VERSION_BUILD 3.1

/* Version is release */
#define CLIENT_VERSION_IS_RELEASE true

/* Major version */
#define CLIENT_VERSION_MAJOR 2.1

/* Minor version */
#define CLIENT_VERSION_MINOR 0.1

/* Build revision */
#define CLIENT_VERSION_REVISION 0.1
...
#define PACKAGE_BUGREPORT "https://wilo.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Wilo Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Wilo Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "wilo"
